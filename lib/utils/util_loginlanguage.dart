...
Widget buttomLogin(BuildContext context){

  String language =  Provider.of<ChangeLanguage>(context).chooseLanguage;

  if(language == "pt"){
    return ElevatedButton(
      onPressed: () => Routes.routeHome(context) ,
      style: ElevatedButton.styleFrom(
        backgroundColor: Background().strongBlue(),
      ),
      child: Text(
        AppLocalizationsPt().buttomLogin ,
    ...
    return ElevatedButton(
      ...
      child: Text(
        AppLocalizationsEn().buttomLogin,
        style: TextStyle(color: Background().orangeYellow(),fontSize: 18),
      ),
    );
  }else{
    return ElevatedButton(
      ...
      child: Text(
        AppLocalizationsEs().buttomLogin,
        style: TextStyle(color: Background().orangeYellow(),fontSize: 18),
      ),
    );
  }
